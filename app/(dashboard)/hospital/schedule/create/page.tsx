...
export default function ScheduleCreatePage() {
    ...
    return (
        <div className='w-full'>
            <h1 className='w-[80%] text-xl font-bold'>Create Schedule</h1>

            <div className='flex justify-center items-center h-full flex-col w-[80%]'>

                <form className='mt-2 space-y-10 w-[80%]'>    
                <Card className="w-[60%]">
                <CardHeader>
                ...
                <CardContent>
                    ...
                    <div className="grid w-full items-center gap-4">
                        ...
                        <div className="flex flex-col space-y-1.5">
                        <Label htmlFor="framework">Start time</Label>
                        <Select>
                            <SelectTrigger id="framework">
                            <SelectValue placeholder="Select" />
                            </SelectTrigger>
                        ...
                        <div className="flex flex-col space-y-1.5">
                        <Label htmlFor="framework">End time</Label>
                        <Select>
                            <SelectTrigger id="framework">
                            <SelectValue placeholder="Select" />
                            </SelectTrigger>
