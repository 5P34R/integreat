export default function IntegreatBottomBar() {
    return (
        <div
                    className="py-10 lg:w-1/4 md:w-1/4  flex lg:flex-col md:flex-col flex-row lg:invisible md:invisible visible items-center mx-auto justify-center text-center">
                    {/* <!-- icons -->
                    <!-- create pdf --> */}
                    <a className="justify-center items-center text-center p-2" href="#">
                        <div className="flex  mx-auto w-14 h-14 rounded-full justify-center items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                direction="ltr" className="sc-gsFSXq cUibyN sc-fMMURN ccOEUw">
                                <g id="description">
                                    <path id="Vector"
                    ...
                    <a className="justify-center items-center text-center p-2" href="#">
                        <div
                            className="flex  mx-auto w-14 h-14 rounded-full justify-center items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                direction="ltr" className="sc-gsFSXq cUibyN sc-fMMURN ccOEUw">
                                <g id="share">
                                    <path id="Vector"
